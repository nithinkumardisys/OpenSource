//------------------------------------------------------------------------------
// <copyright file="DTOBlock.cs" company="Government of Bihar">
...
namespace ADIDAS.Model.DTO
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoBlock"/> class.
        /// Gets or Sets DtoBlock.
        /// </summary>
        public DtoBlock()
        {
            this.PanchayatList = new List<DtoPanchayat>();
        }
        ...
        /// </summary>
        public List<DtoPanchayat> PanchayatList { get; set; }
    }

    /// <summary>
    /// Panchayat.
    /// </summary>
    public class DtoPanchayat
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="DtoPanchayat"/> class.
        /// Gets or Sets DtoBlock.
        /// </summary>
        public DtoPanchayat()
        {
            this.VillageList = new List<DtoVillage>();
        }
        ...
        /// </summary>
        public List<DtoVillage> VillageList { get; set; }
    }

    /// <summary>
    /// Village.
    /// </summary>
    public class DtoVillage
    {
        /// <summary>
        /// Gets or Sets Panchayat_Id.
        /// </summary>
