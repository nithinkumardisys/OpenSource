//------------------------------------------------------------------------------
// <copyright file="DTOCropDamageBlock.cs" company="Government of Bihar">
...
namespace ADIDAS.Model.DTO
{
    ...
    /// Crop Damage Block.
    /// </summary>
    public class DtoCropDamageBlock
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DtoCropDamageBlock"/> class.
        /// </summary>
        public DtoCropDamageBlock()
        {
            this.PanchayatList = new List<DtoCropDamagePanchayat>();
        }
        ...
        /// </summary>
        public List<DtoCropDamagePanchayat> PanchayatList { get; set; }
    }

    /// <summary>
    /// Crop Damage Panchayat.
    /// </summary>
    public class DtoCropDamagePanchayat
    {
        /// <summary>
        /// Gets or Sets Block_Id.
        /// </summary>
