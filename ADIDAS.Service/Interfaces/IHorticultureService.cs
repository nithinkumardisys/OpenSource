//------------------------------------------------------------------------------
// <copyright file="IHorticultureService.cs" company="Government of Bihar">
...
namespace ADIDAS.Service.Interfaces
{
    ...
    public interface IHorticultureService
    {
        /// <summary>
        /// InsertColdStorage.
        /// </summary>
        ...
        /// </summary>
        /// <param name="district_Id">district_Id.</param>
        /// <returns>GetAllCropColdStorage list.</returns>
        ...
        /// <returns>GetAllCropColdStorageId list.</returns>
        ...
        /// </summary>
        /// <param name="district_Id">district_Id.</param>
        /// <returns>LstCpldStorageDets list.</returns>
        ...
        /// <returns>CropDamageBlockApprovalResponse list.</returns>
        ...
        /// <returns>CropDamagePanchayatResponse list.</returns>
        ...
        /// <returns>FacilityOnline list.</returns>
        ...
        /// <returns>HortCropCoverageActual list.</returns>
        ...
        /// </summary>
        /// <param name="district_id">District_id.</param>
        /// <returns>DistinctHorticultureCrop list.</returns>
