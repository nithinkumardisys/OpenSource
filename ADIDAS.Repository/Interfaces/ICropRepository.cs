//------------------------------------------------------------------------------
// <copyright file="ICropRepository.cs" company="Government of Bihar">
...
namespace ADIDAS.Repository.Interfaces
{
    ...
    public interface ICropRepository
    {
        ...
        /// GetSeason.
        /// </summary>
        /// <returns>Values from DB.</returns>
        ...
        /// </summary>
        /// <param name="districtId">districtId.</param>
        /// <returns>Distinct Crop Details.</returns>
        ...
        /// </summary>
        /// <param name="districtId">districtId.</param>
        /// <returns>Values of LG District. </returns>
        ...
        /// <returns>LG Directory Block.</returns>
        ...
        /// <returns>Values of LG Directory Pancht. </returns>
        ...
        /// <param name="season_id">season_id.</param>
        /// <param name="crop_id">crop_id.</param>
        /// <returns>Crop Damage DAO.</returns>
        ...
        /// <param name="season_id">season_id.</param>
        /// <param name="crop_id">crop_id.</param>
        /// <returns>Crop Coverage Actual BAO.</returns>
        ...
        /// <param name="season_id">season_id.</param>
        /// <param name="crop_id">crop_id.</param>
        /// <returns>Crop Damage BAO.</returns>
        ...
        /// <param name="blockId">blockId.</param>
        /// <returns>InsBaoCropdmgModel.</returns>
        List<InsBaoCropdmgModel> GetBAOCropDamageDetailsBlockOffline(int districtId, int blockId);
        ...
        /// </summary>
        /// <param name="district_Id">district_Id.</param>
        /// <returns>GetCropDamageReasonDrpDwn.</returns>
        ...
        /// <returns>Response.</returns>
        int PostCropCoverageDamageDetails(InsCropCoverageDamageDetails postCropCoverageDamageDetails);

        /// <summary>
        /// PostDamageDetails.
        /// </summary>
        /// <param name="damageDetails">damageDetails.</param>
        /// <returns>DtoPostDamageResponse Response.</returns>
        ...
        /// <returns>CropResponce Response. </returns>
        CropResponce PostCropCvgDamagePancytApproval(CropDamageGetAll insCropDamagePancytApproval);
        ...
        /// </summary>
        /// <param name="districtId">districtId.param>
        /// <returns>CoverageSubmittedCropsSeason.</returns>
        ...
        /// <param name="year">year.</param>
        /// <param name="crop_type">crop_type.</param>
        /// <returns>GetSeasonByYearModel.</returns>
        ...
        /// <param name="season_id">season_id.</param>
        /// <param name="crop_type">crop_type.</param>
        /// <returns>GetCropBySeasonIdModel.</returns>
